"""P190 NavConverter Toast — Non-blocking notification (bottom-right)."""
...
class ToastWidget(QWidget):
    ...
    def _remove(self):
        # Remove from manager list synchronously before Qt cleanup
        mgr = ToastManager.instance()
        if mgr and self in mgr._toasts:
            mgr._toasts.remove(self)
...
class ToastManager:
    ...
    def _position_toasts(self):
        ...
        for toast in list(reversed(self._toasts)):
